...
class _LogInState extends State<LogIn> {
  ...
  void authUser(String uname, String pswd) async {
    String url = 'https://192.168.1.10:45455/api/CustPerson/login/$uname/$pswd';
    ...
    if (res.statusCode == 200) {
      ...
      String url1 =
          'http://192.168.1.10:45455/api/OTPController/GetOTP/${custPerson.cPerUName}/${custPerson.custPersonEmail}';
